...
if __name__ == "__main__":
    ...
    for i in range(1,9):
            ...
            start_video_recording('video_position_tryBBNG_'+str(i)+'.avi', vial_size_input)
            if vial_size_input == int(8):
                time.sleep(5)
            elif vial_size_input == int(20):
                time.sleep(20)
            stop_video_recording('video_position_tryBBNG_'+str(i)+'.avi')
